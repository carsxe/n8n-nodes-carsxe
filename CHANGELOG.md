...
- Fix n8n community ESLint review: `httpRequestWithAuthentication`, `NodeConnectionTypes.Main`, color param, `NodeApiError`, and themed icons

#### 1.3.1

- Publish via GitHub Actions with npm provenance (`publish.yml`)

#### 1.3.0

- Add Recalls by YMM (`GET /v1/recalls-ymm`)
- Add Recalls Batch submit, status, results, and download operations
- Add YMM Options (`GET /v1/ymm-options`)
- Add Ownership lookups by VIN, person, address, and ZIP (Enterprise)
